...
@section('title', 'Bienvenido a AZOGUE')
    ...
    <section class="main-slider">
        <div id="home_slider_wrapper" class="rev_slider_wrapper fullscreen-container" >
            <div id="home_slider" class="rev_slider fullscreenbanner tiny_bullet_slider" data-version="5.4.1">
                <ul>	<!-- SLIDE  -->
                    <li data-index="rs-73"
                    data-thumb="images/slider/cintaMetrica.jpg"
                    ...
                    data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images/slider/cintaMetrica.jpg"
                        ...
                        <div class="tp-caption   tp-resizeme"
                            ...
                            style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #ffffff; letter-spacing: 10px;font-family:Roboto Condensed;">Estos son nuestros productos</div>
                        ...
                        <div class="tp-caption   tp-resizeme"
                            ...
                            style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Cosas hechas con el corazón</div>
                    </li>
                    <!-- SLIDE  -->
                    <li data-index="rs-74"
                        data-transition="fade"
                        ...
                        data-easeout="default"
                        data-masterspeed="300"
                        data-thumb="images/slider/gafas.jpg"
                        data-rotate="0"
                        data-saveperformance="off"
                        data-title="Slide">
                        <!-- MAIN IMAGE -->
                        <img src="images/slider/gafas.jpg" alt=""
                            data-bgposition="cover"
                            data-bgfit="cover"
                            data-bgrepeat="no-repeat"
                            data-bgparallax="on"
                    ...
                    <li data-index="rs-75"
                        ...
                        data-easeout="default"
                        data-masterspeed="300"
                        data-thumb="images/slider/hilos.jpg"
                        data-rotate="0"
                        data-saveperformance="off"
                        data-title="Slide"
                        data-param1=""
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images/slider/hilos.jpg"
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            ...
                            <img class="img-responsive" src="{{ $product->images()->first()->image }}" alt="product-img" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-short-details">
                                        ...
                                        <a href="cart.html" class="btn btn-main">Añadir a la cesta</a>
                                        <a href="product-single.html" class="btn btn-transparent">Mas informacion</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="title">
                        <h2>¿Quieres recibir nuestra newsletter?</h2>
                        <p>Un monton de cosas bonitas para que les eches un vistazo, <br> llegaran a tu correo sin ningun compromiso.</p>
                    </div>
                    <div class="col-lg-6 col-md-offset-3">
                        <div class="input-group subscription-form">
                        <input type="text" class="form-control" placeholder="Escribe tu correo electronico aquí">
                        <span class="input-group-btn">
                            <button class="btn btn-main" type="button">Apuntate ¡Ya!</button>
                        </span>
                        </div><!-- /input-group -->
                </div><!-- /.col-lg-6 -->
